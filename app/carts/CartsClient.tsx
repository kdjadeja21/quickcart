    ...
    <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 min-h-screen">
      ...
      <div className="container mx-auto max-w-5xl px-4 py-8 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card className="overflow-hidden bg-gradient-to-br from-white via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-900/50 dark:to-slate-800">
            ...
            <CardContent>
              <div className="flex items-baseline gap-2">
                <div className="text-3xl font-semibold">{widgets.cartCount}</div>
                <div className="text-sm text-muted-foreground">/ {MAX_CARTS}</div>
              </div>
          ...
          <Card className="overflow-hidden bg-gradient-to-br from-white via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-900/50 dark:to-slate-800">
            <CardHeader className="pb-2">
              <CardTitle>Average Cart Total</CardTitle>
              <CardDescription>Across all carts</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-semibold">{formatCurrency(widgets.avg, currentCurrency)}</div>
            </CardContent>
          </Card>
        </div>
